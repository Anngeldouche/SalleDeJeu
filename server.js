				...
				<html>
					...
					<body>
						<div class="exported-note"><div class="exported-note-title">server.js</div>
...
.mermaid-export-graph {
				...
				}</style><div id="rendered-md"><p>const express = require('express');<br>
const cors = require('cors');<br>
const app = express();<br>
const port = 3000;</p>
<p>let drawings = []; // Pour stocker les dessins</p>
<p>app.use(cors()); // Permet les requêtes depuis d'autres origines<br>
app.use(express.json()); // Pour traiter les données JSON</p>
<p>// Route pour enregistrer un dessin<br>
app.post('/saveDrawing', (req, res) =&gt; {<br>
const { drawing } = req.body; // Récupère le dessin envoyé<br>
drawings.push(drawing); // Ajoute le dessin à notre tableau<br>
res.send('Dessin enregistré');<br>
});</p>
<p>// Route pour récupérer les dessins<br>
app.get('/getDrawings', (req, res) =&gt; {<br>
res.json({ drawings }); // Envoie tous les dessins<br>
});</p>
<p>// Lancer le serveur<br>
app.listen(port, () =&gt; {<br>
console.log(<code class="inline-code">Serveur en ligne sur http://localhost:${port}</code>);<br>
});</p>
</div></div>
					</body>
				</html>
